...
<h4> Answer:</h4> As you all know in the start of the main function we use infinite while  loop so it will give the choice to Sign-Up, log-In and Exit option again and again
