...
<h4> Answer:</h4> As you all know in the start of the main function we use infinite while  loop so it will give the choice to <b>Sign-Up, log-In and Exit <b> option again and again
