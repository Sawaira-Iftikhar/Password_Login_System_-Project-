...
<h2 align="center"><strong>Password Login System</strong></h2>
 ...
 <br>
  Constants set the limits for users, attempts and password length. Two arrays store all usernnames and Passwords side by side -- the same index in both belongs to one parson.
